# Revision Notes:
# Topic: Static methods and @staticmethod usage
...
class Student:
    @staticmethod      #decorator: it allows us to wrap another function in order to  extend the behavior of the fn,without permanently modifying it
    def hello():7
    print("Hello!")
